...
#+PROPERTY: header-args :tangle "~/.emacs.d/config/elisp/config-functions.el"
#+auto_tangle: t
...
** Prompt for autosave file deletion
#+begin_src emacs-lisp
...
** Arch Linux system update function
Spawns a vterm instance and runs:
- yay
- fud (alias in .bashrc for "flatpak update"

This function will only be defined for Emacs when the system is an Arch Linux system
#+begin_src emacs-lisp
